...
[![Build Status](https://dev.azure.com/gltf-dx-viewer/glTF-DXViewer/_apis/build/status/development?branchName=master)](https://dev.azure.com/gltf-dx-viewer/glTF-DXViewer/_build/latest?definitionId=1&branchName=master)
